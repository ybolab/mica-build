...
- `rootfs/` — Alpine demo rootfs variants + WiFi firmware blobs (AP6275S / AIC8800 dual SKU)
...
- WiFi credentials are hardcoded in rootfs/alpine-rom (demo only — do not reuse).
