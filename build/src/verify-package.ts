// The one place build reaches into verify. build imports verify's
// typed board model rather than copying it -- one parser for
// `boards/<board>/board.env` -- and build's tsconfig typechecks what it
...
//
// Everything build takes from verify comes through here, so the coupling
