...
The collector is [`tests/cx3576-bench/collect.sh`](../../tests/cx3576-bench/collect.sh). It is
...
> status: board-dependent — evidence: `docs/boards/cx3576.md`, `tests/cx3576-bench/collector-test.sh`
...
report behaviour is covered by `tests/cx3576-bench/collector-test.sh`. A
