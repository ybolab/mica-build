...
deliverables can carry a Mica OS port, under what conditions, and with what loss
...
1. **Can we build it?** Which inputs are source, which are blobs, which are
   ...
   [BSP contract](../boards/contract.md)?
...
> status: shipped — evidence: `docs/boards/contract.md`
...
> status: shipped — evidence: `docs/boards/board-template.md`, `docs/boards/qualification.md`
...
meet that constraint, and Mica OS deliberately does not impose it — but evidence
is.
...
[docs/boards/cx3576-bsp-sync.md](../boards/cx3576-bsp-sync.md):
...
> status: board-dependent — evidence: `docs/boards/cx3576-bsp-sync.md`
