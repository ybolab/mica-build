...
- Content: prose uses the Mica OS name while identifiers keep `mos`; one board
  ...
  names removed from permanent documents; `mosd.md`, `remote-management.md`,
...
**Mosd workspace tests consolidated and repository prose audited**
