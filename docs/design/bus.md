...
(around `docs/design/api.md:1466`) applies to the bus itself: **the value of
...
5. **[implemented]** **The item façade redacts secrets and `GetSettings` does
   ...
   `get_settings("access")` (`os/pkgs/mosd/apid/src/routes.rs:4372`) and lifts
   `webAdmin.password_hash` out of the reply (`os/pkgs/mosd/apid/src/routes.rs:4348`,
