...
`GetState("network")` at `os/pkgs/mosd/apid/src/routes.rs:3063`, whose result is rendered
...
- **Feed:** `GetSettings("hostname")` — already called at
  `os/pkgs/mosd/apid/src/routes.rs:3062`; `GetSettings("provisioning")`, which returns
