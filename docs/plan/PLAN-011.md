...
| M3 | `mos-mqttd` (D6) — the MQTT data-publishing bridge over the M1/M2 tree | protocol tests against a local broker: N/R/W, keepalive republish, masking, read-only mode |
