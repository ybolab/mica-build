...
The final ed723 image is accepted. The first real guest refused SYSTEM discovery
and powered off during partial startup; the unchanged API readiness deadline
continues. Preserve the actual GPT/caller mismatch and all pending acceptance.
