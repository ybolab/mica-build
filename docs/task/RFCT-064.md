...
| --- | --- | --- |
| 2.1 | `docs/design/api.md:526` | Versioning and path shape |
...
API versions the appliance serves (`docs/design/api.md:630-634`). It is accepted
...
custom header, no signature, no timestamp (`docs/design/api.md:1196`). It is
