...
- **status**: complete — sections 4, 5, 6 and 10.2 proposed; the traversal rules and the fallback are specified to the point of being testable
- **priority**: P1
- **owner**: ai-agent
...
default"* (`docs/design/api.md:1685-1688`).
