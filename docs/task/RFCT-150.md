...
| `os/verify/src/checks.ts:373` | 23 | the content-keyed cache rule and the publish-by-rename rule, both with the defect each prevents |
...
| `os/verify/src/checks.ts:280` | 15 | a register invariant stated at the code that holds it |
