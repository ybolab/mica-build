...
| `docs/design/api.md:3549` | `` (`update/sign`, RFCT-016). `mos-sign` is a member of the `` | live design doc; also a factual claim the extraction falsifies |
