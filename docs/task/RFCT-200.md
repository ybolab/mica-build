...
(`os/pkgs/mosd/apid/src/routes.rs:3440`). `network_submit` builds the value
(`os/pkgs/mosd/apid/src/routes.rs:3458-3474`) and writes it as a dot-path,
...
Form input (`NetworkForm`, `os/pkgs/mosd/apid/src/routes.rs:4785-4842`) →
...
(`os/pkgs/mosd/apid/src/routes.rs:3396-3401`), the reconciler rejects it
