...
of alphanumerics plus `.`, `_`, `-` (`os/pkgs/mosd/apid/src/routes.rs:3368-3373`),
and the pane's error text advertises the dot
(`os/pkgs/mosd/apid/src/routes.rs:3412`). `network_submit` builds the value
(`os/pkgs/mosd/apid/src/routes.rs:3430-3446`) and writes it as a dot-path,
...
Form input (`NetworkForm`, `os/pkgs/mosd/apid/src/routes.rs:4757-4814`) →
...
(`os/pkgs/mosd/apid/src/routes.rs:3434`); paths the daemon
...
(`os/pkgs/mosd/apid/src/routes.rs:3368-3373`), the reconciler rejects it
...
also discharges the debt api.md records at `docs/design/api.md:4383-4393`
