...
of alphanumerics plus `.`, `_`, `-` (`os/pkgs/mosd/apid/src/routes.rs:1134-1139`),
and the pane's error text advertises the dot
(`os/pkgs/mosd/apid/src/routes.rs:1178`). `network_submit` builds the value
(`os/pkgs/mosd/apid/src/routes.rs:1196-1212`) and writes it as a dot-path,
...
Form input (`NetworkForm`, `os/pkgs/mosd/apid/src/routes.rs:2280-2337`) →
...
(`os/pkgs/mosd/apid/src/routes.rs:1200`); paths the daemon
...
(`os/pkgs/mosd/apid/src/routes.rs:1134-1139`), the reconciler rejects it
...
also discharges the debt api.md records at `docs/design/api.md:4346-4356`
