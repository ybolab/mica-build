...
(`os/pkgs/mosd/apid/src/routes.rs:424-425`).
...
none."* (`os/pkgs/mosd/apid/src/routes.rs:479`).
...
(`os/pkgs/mosd/apid/src/routes.rs:4369`), rather than the switch text that moves
with the setting.
