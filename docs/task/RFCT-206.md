...
(`os/pkgs/mosd/apid/src/routes.rs:329`) and the gate releases it because
*"`/api/versions` is unauthenticated by design"*
(`os/pkgs/mosd/apid/src/routes.rs:387-388`).
...
none."* (`os/pkgs/mosd/apid/src/routes.rs:426`).
...
(`os/pkgs/mosd/apid/src/routes.rs:3657`), rather than the switch text that moves
with the setting.
