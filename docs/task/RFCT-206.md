...
(`os/pkgs/mosd/apid/src/routes.rs:285`) and the gate releases it because
*"`/api/versions` is unauthenticated by design"*
(`os/pkgs/mosd/apid/src/routes.rs:298-299`).
...
none."* (`os/pkgs/mosd/apid/src/routes.rs:335`).
...
(`os/pkgs/mosd/apid/src/routes.rs:3169`), rather than the switch text that moves
with the setting.
