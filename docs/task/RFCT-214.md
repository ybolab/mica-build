...
|---|---|---|---|---|
| full | *"fn api_router() -> Router<AppState> {"* (`os/pkgs/mosd/apid/src/routes.rs:397`) | yes | yes | when armed with a quote |
...
(`os/pkgs/mosd/apid/src/routes.rs:1230`). Main corrected the same quote in two
