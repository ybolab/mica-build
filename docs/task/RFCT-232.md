...
(`docs/design/api.md:1610`) as the 404 row and the fix agrees with it; that file
...
(`os/pkgs/mosd/apid/src/tests.rs:4295`) is the settings route's existing
...
(`os/pkgs/mosd/apid/src/tests.rs:4219`) failed with *"left: 404"* against
