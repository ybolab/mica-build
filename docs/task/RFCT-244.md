...
(`os/pkgs/mosd/apid/src/tests.rs:10151`) asserts the member set exactly, and then
...
(`os/pkgs/mosd/apid/src/tests.rs:10382`) drives both surfaces against **one**
...
(`os/pkgs/mosd/apid/src/tests.rs:10347`) is the case that would be refused by a
...
(`os/pkgs/mosd/apid/src/tests.rs:10413`) drives four rejections and asserts, for
...
(`os/pkgs/mosd/apid/src/tests.rs:10201`), which also asserts the wizard's opposite
...
(`os/pkgs/mosd/apid/src/tests.rs:10243`) drives **one** partial failure through
...
The fixture is `RefusesOnePath` (`os/pkgs/mosd/apid/src/tests.rs:10076`), added
...
(`os/pkgs/mosd/apid/src/tests.rs:10664`) sends the same entry three ways and,
...
(`os/pkgs/mosd/apid/src/tests.rs:10500`) holds the absent member, and
`a_rejected_setup_password_is_never_echoed`
(`os/pkgs/mosd/apid/src/tests.rs:10475`) holds that no refusal repeats the
...
(`os/pkgs/mosd/apid/src/tests.rs:10521`) asserts both halves in setup mode, which
...
(`os/pkgs/mosd/apid/src/tests.rs:10570`) checks the event and that neither the
