...
(`os/pkgs/mosd/apid/src/tests.rs:9934`) asserts the member set exactly, and then
...
(`os/pkgs/mosd/apid/src/tests.rs:10165`) drives both surfaces against **one**
...
(`os/pkgs/mosd/apid/src/tests.rs:10130`) is the case that would be refused by a
...
(`os/pkgs/mosd/apid/src/tests.rs:10196`) drives four rejections and asserts, for
...
(`os/pkgs/mosd/apid/src/tests.rs:9984`), which also asserts the wizard's opposite
...
(`os/pkgs/mosd/apid/src/tests.rs:10026`) drives **one** partial failure through
...
The fixture is `RefusesOnePath` (`os/pkgs/mosd/apid/src/tests.rs:9859`), added
...
(`os/pkgs/mosd/apid/src/tests.rs:10447`) sends the same entry three ways and,
...
(`os/pkgs/mosd/apid/src/tests.rs:10283`) holds the absent member, and
`a_rejected_setup_password_is_never_echoed`
(`os/pkgs/mosd/apid/src/tests.rs:10258`) holds that no refusal repeats the
...
(`os/pkgs/mosd/apid/src/tests.rs:10304`) asserts both halves in setup mode, which
...
(`os/pkgs/mosd/apid/src/tests.rs:10353`) checks the event and that neither the
