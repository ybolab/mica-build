...
(`os/pkgs/mosd/apid/src/tests.rs:10038`) asserts the member set exactly, and then
...
(`os/pkgs/mosd/apid/src/tests.rs:10269`) drives both surfaces against **one**
...
(`os/pkgs/mosd/apid/src/tests.rs:10234`) is the case that would be refused by a
...
(`os/pkgs/mosd/apid/src/tests.rs:10300`) drives four rejections and asserts, for
...
(`os/pkgs/mosd/apid/src/tests.rs:10088`), which also asserts the wizard's opposite
...
(`os/pkgs/mosd/apid/src/tests.rs:10130`) drives **one** partial failure through
...
The fixture is `RefusesOnePath` (`os/pkgs/mosd/apid/src/tests.rs:9963`), added
...
(`os/pkgs/mosd/apid/src/tests.rs:10551`) sends the same entry three ways and,
...
(`os/pkgs/mosd/apid/src/tests.rs:10387`) holds the absent member, and
`a_rejected_setup_password_is_never_echoed`
(`os/pkgs/mosd/apid/src/tests.rs:10362`) holds that no refusal repeats the
...
(`os/pkgs/mosd/apid/src/tests.rs:10408`) asserts both halves in setup mode, which
...
(`os/pkgs/mosd/apid/src/tests.rs:10457`) checks the event and that neither the
