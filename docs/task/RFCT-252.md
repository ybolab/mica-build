...
it with `grep -q '^<!-- dated-record:'` (`docs/verify-citations.sh:356`).
...
(`docs/task/RFCT-215.md:284-286`). Measured here, on both readings of what
"Section 1.2" names:
...
- **RFCT-215 has no section 1.2.** Its section 1, *"What section 1 said, and
  ...
  (`docs/task/RFCT-215.md:280-281`). A search for the negative it is said to
...
(`docs/verify-citations.sh:109-111`). Two of the five are inside the verbatim
