...
- [x] [**RFCT-314 PLAN-070 F6c-F6f: the /mos/config namespace and the settings move**](RFCT-314.md) `P1`
- [x] [**RFCT-321 PLAN-071 U4/U5 and the clock predicate**](RFCT-321.md) `P1`
...
- [x] [**RFCT-326 PLAN-070 F6g: the pour, with per-document refusal**](RFCT-326.md) `P1`
- [x] [**RFCT-327 PLAN-071 U11/U8/U7: the write route, the actor, the console**](RFCT-327.md) `P1`
...
- [x] [**RFCT-338 Gate C: adopt the 35 triage rulings**](RFCT-338.md) `P1`
- [x] [**RFCT-340 Gate A: the keyring rotation channel**](RFCT-340.md) `P1`
