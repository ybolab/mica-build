...
# documents they describe, DELIBERATELY. There is no shared token to assert: the bullets and
...
# heading -- the connd case. A check that cannot fail on
...
#
# The Chinese tree under docs/zh/ is not asserted here. It is indexed by its
# own docs/zh/README.md and is a translation of the English record, not a
# second set of documents a reader could fail to find.
set -euo pipefail
