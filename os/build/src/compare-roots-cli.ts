...
export const DEFAULT_LEDGER = join(REPO_ROOT, 'os', 'tests', 'dual-build-sanctions.md')

const USAGE = `usage: bash os/build/run.sh --compare-roots [--sanctions FILE] DIR_A DIR_B
