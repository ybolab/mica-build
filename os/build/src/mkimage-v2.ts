// os/mkimage-v2.sh, ported: the flashable cx3576 (Rockchip RK3576, eMMC
...
// os/boards/cx3576/board.env, through os/verify's typed model and this
...
export interface AssemblyInputs {
  ...
  /** Defaults to the tree's own os/boards/cx3576/boot.cmd. */
 ...
 * Assemble the image.
 *
 * The order of the refusals below is os/mkimage-v2.sh's, and it is kept: a
