...
pub use model::{
    ...
    MAX_PASSPHRASE_LEN, MIN_PASSPHRASE_LEN, MqttListenSettings, MqttSettings, ProvisioningSettings,
    ProvisioningState, RAW_PMK_LEN, SCHEMA_VERSION, Settings, SshSettings, StaticConfig, VlanConfig,
