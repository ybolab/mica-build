...
# with, into os/rauc/.devkeys/ (gitignored).
#
#   bash os/rauc/gen-dev-keys.sh            generate if absent, otherwise no-op
#   bash os/rauc/gen-dev-keys.sh --force    regenerate, replacing what is there
#
...
echo "and rebuild the image. Do not do this for anything that leaves your desk."
