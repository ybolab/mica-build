...
//
// PLAN-014 M4g (RFCT-110). `walkLayout` needs a verity-slot size, because the
// board definition deliberately does not declare where everything after the
// slots begins -- the slot size is content-derived and read back from the GPT
