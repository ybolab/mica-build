...
# run from pkgs/micad/ stopped reaching this crate. Without this script the code would
# ship unchecked with every other gate still green.
#
# Deliberately a line-for-line twin of pkgs/micad/hack/check.sh, in the same order.
