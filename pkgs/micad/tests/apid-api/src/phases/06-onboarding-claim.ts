 ...
 * ever reached.
 *
 * WHY THIS IS HERE AND NOT A RUST TEST. `pkgs/micad/apid/src/tests/claim.rs`
 ...
 * micad's own store. That is what one boot buys: `via: "setup"` here is the
 ...
 * unreachable from this harness: `mica-provisioning-import` runs before anything
