/**
 * The build-time half of `pkgs/micad/tests/apid-api`: every phase literal that is ALSO
 * stated in `pkgs/micad/apid/openapi.json`, asserted to agree with it.
 *
 ...
 *
 *     bun run spec-pins          # from pkgs/micad/tests/apid-api
 *     make os-apid-api-spec-pins # from the repository root, in the pinned bun
 */

const REPO_ROOT = new URL("../../../../../", import.meta.url);
const OPENAPI = new URL("pkgs/micad/apid/openapi.json", REPO_ROOT);
