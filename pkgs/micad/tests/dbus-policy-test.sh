...
POLICY="${REPO_ROOT}/pkgs/micad/dist/com.mica.micad.conf"
NAME=com.mica.micad
...
check "mqttd: legacy global extension policy is absent" "ABSENT" \
    "$([ ! -e "${REPO_ROOT}/pkgs/micad/dist/com.mica.ext.conf" ] && echo ABSENT || echo PRESENT)"
check "mqttd: legacy micad exception policy is absent" "ABSENT" \
    "$([ ! -e "${REPO_ROOT}/pkgs/micad/dist/mica-mqttd.conf" ] && echo ABSENT || echo PRESENT)"
