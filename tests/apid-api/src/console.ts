 ...
 * systemd and by micad instead. It is also the only usable journal: the image
  ...
  constructor(path: string | undefined) {
    ...
    if (path === undefined) {
      this.#unavailable =
        ...
        "Console-backed checks observe the DEVICE acting (systemd and micad write those " +
 ...
 *
 * Use this ONLY where the wording was measured -- micad's container reconciler
 ...
 * systemd versions, and micad's audit mirroring was not read from this side.
