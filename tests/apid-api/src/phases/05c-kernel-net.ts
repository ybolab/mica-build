 ...
 *
 * THE GUEST SIDE IS NOT HERE. `tests/apid-api/guest/m7-net-smoke.sh` runs inside
...
const phase: Phase = {
  ...
  assumes:
    "the guest booted from a disk that run.sh seeded with tests/apid-api/guest/m7-net-smoke.sh " +
    ...
    if (found.size === 0) {
      ...
      report.fail(
        ...
        [
          ...
          "actual:   none. The guest never ran tests/apid-api/guest/m7-net-smoke.sh, so NOTHING",
