...
// boards/x64/board.env declared BOOT_ATTEMPTS_DEFAULT=3 under a comment
 ...
 * key. Measured against the real consumer: pkgs/rauc/render-config.sh
...
function lintPartitionSet(r: Recorder, b: Board): void {
  ...
  // partition -- see the comment in rootfs/build.sh.
 ...
 *
 * This was a literal, and a board added under boards/ was therefore a board
